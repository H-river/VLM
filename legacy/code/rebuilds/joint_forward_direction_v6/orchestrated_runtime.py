"""Shared-v6 overlay on the frozen Qwen and numerical-v5 system."""
...
from joint_forward_direction_v6.runtime import (
    load_forward_direction_runtime_v6,
)


class OrchestratedSharedRuntimeV6:
    ...
    def __init__(
        ...
        self.shared, _ = load_forward_direction_runtime_v6(
            shared_artifact,
            torch,
            device,
        )
