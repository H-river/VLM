#!/usr/bin/env python3
"""Evaluate v7 routing, compact source mappings, and tool-result interpretation."""
...
def evaluate(
    ...
    summary = {
        ...
        "mapped_tool_execution_match": rate("tool_source_mapping", "mapped_tool_execution_match"),
    ...
    checks = {
        ...
        "interpretation_status_macro_f1": bool(status_f1) and all(value >= float(gates["interpretation_status_macro_f1"]) for value in status_f1.values()),
