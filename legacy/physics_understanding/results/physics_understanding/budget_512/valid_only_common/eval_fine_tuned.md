...
- Predictions: `profile2setup/results/physics_understanding/budget_512/valid_only_common/predictions_fine_tuned.jsonl`
...
- `allowed_variable_constraint`: `45` probes, success_rate `0.8667`
- `contradiction_detection`: `54` probes, success_rate `1.0000`
- `fixed_variable_constraint`: `21` probes, success_rate `1.0000`
- `paraphrase_consistency`: `32` probes, success_rate `0.0000`
- `prompt_image_conflict`: `48` probes, success_rate `0.1250`
- `prompt_sensitivity`: `22` probes, success_rate `0.8636`

## Language And Physics Metrics

- paraphrase_consistency_score: `0.8750` (higher is better).
- prompt_sensitivity_score: `0.0000` (higher is better).
- fixed_variable_violation_rate: `0.0000` (lower is better).
- allowed_variable_violation_rate: `0.1250` (lower is better).
- contradiction_detection_accuracy: `1.0000` (higher is better).
- prompt_image_conflict_detection_accuracy: `0.1250` (higher is better).
- direction_accuracy: `0.6429` (higher is better).
- direction_flip_accuracy: not scored for this prediction set.
- forced_prediction_rate: `0.3824` (lower is better).
...
- `conflict`: rows `48`, success_rate `0.1250`, direction_accuracy `n/a`, forced_prediction_rate `0.8125`
- `images_only`: rows `0`, success_rate `n/a`, direction_accuracy `n/a`, forced_prediction_rate `n/a`
- `prompt_only`: rows `13`, success_rate `1.0000`, direction_accuracy `n/a`, forced_prediction_rate `0.0000`
- `prompt_plus_images`: rows `161`, success_rate `0.7453`, direction_accuracy `0.6429`, forced_prediction_rate `0.0000`
