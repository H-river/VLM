...
- Predictions: `profile2setup/results/physics_understanding/budget_512/valid_only_common/predictions_base.jsonl`
...
- `allowed_variable_constraint`: `45` probes, success_rate `0.3333`
- `contradiction_detection`: `54` probes, success_rate `1.0000`
- `fixed_variable_constraint`: `21` probes, success_rate `0.3810`
- `paraphrase_consistency`: `32` probes, success_rate `0.0000`
- `prompt_image_conflict`: `48` probes, success_rate `1.0000`
- `prompt_sensitivity`: `22` probes, success_rate `0.5000`

## Language And Physics Metrics

- paraphrase_consistency_score: `1.0000` (higher is better).
...
- prompt_image_conflict_detection_accuracy: `1.0000` (higher is better).
- direction_accuracy: `0.1830` (higher is better).
...
- `conflict`: rows `48`, success_rate `1.0000`, direction_accuracy `n/a`, forced_prediction_rate `0.0000`
...
- `prompt_plus_images`: rows `161`, success_rate `0.4658`, direction_accuracy `0.1830`, forced_prediction_rate `0.0000`
