#!/usr/bin/env python3
"""Evaluate forward-tool routing, opaque-state mapping, and quantitative replay."""
...
from .forward_prediction_tool import materialize_forward_answer, run_mapped_forward_tool
    ...
    for record in records:
        ...
        if stage == "tool_choice":
            ...
            if prediction and isinstance(prediction.get("source_map"), Mapping):
                try:
                    result = run_mapped_forward_tool(
                    ...
                    detail["materialized_answer_exact"] = value_equal(
                        materialize_forward_answer(result),
