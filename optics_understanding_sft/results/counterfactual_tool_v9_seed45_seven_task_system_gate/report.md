...
Passed: **True**
Equal-task macro: **0.975** (direct-only reference: 0.673)

| Task | Route | Score | Direct-only reference |
|---|---|---:|---:|
| setup_interpretation | direct_structured_answer | 0.967 | 0.967 |
| information_sufficiency | enumerate_compatible_completions_then_compact_interpretation | 1.000 | 0.260 |
...
| counterfactual_reasoning | registered_paired_state_deterministic_simulator | 1.000 | 0.780 |
