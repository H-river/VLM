...
| constrained_intervention | 60 | 0.500 | 100.0% | 98.3% |
| counterfactual_reasoning | 0 | n/a | n/a | n/a |

| Modality | N | Score | JSON | Schema |
|---|---:|---:|---:|---:|
| text | 120 | 0.500 | 100.0% | 99.2% |

Total generation latency: **258.6 s**; mean: **2.15 s/record**.
Mean tokens: **623.8 input / 41.9 output**. Peak allocated CUDA memory: **2.45 GiB**.
