...
Macro task score: **0.497**
Valid JSON: **100.0%**; valid schema: **100.0%**.

| Task | N | Score | JSON | Schema |
|---|---:|---:|---:|---:|
| setup_interpretation | 0 | n/a | n/a | n/a |
| information_sufficiency | 60 | 0.500 | 100.0% | 100.0% |
| causal_effects | 0 | n/a | n/a | n/a |
| forward_prediction | 0 | n/a | n/a | n/a |
| diagnosis | 0 | n/a | n/a | n/a |
| constrained_intervention | 60 | 0.493 | 100.0% | 100.0% |
| counterfactual_reasoning | 0 | n/a | n/a | n/a |

| Modality | N | Score | JSON | Schema |
|---|---:|---:|---:|---:|
| text | 120 | 0.497 | 100.0% | 100.0% |

Total generation latency: **260.1 s**; mean: **2.17 s/record**.
Mean tokens: **623.8 input / 42.0 output**. Peak allocated CUDA memory: **2.45 GiB**.
